...
public class C16AutomationExercises {
    ...
    public void test1() throws AWTException, InterruptedException {
        ...
        rbt.mouseWheel(9);
        Thread.sleep(2000);
        driver.findElement(By.xpath("//textarea[@name='message']")).sendKeys("serkan s naber");
        driver.findElement(By.xpath("//a[@class='btn btn-default check_out']")).click();

        //13. Enter payment details: Name on Card, Card Number, CVC, Expiration date
        driver.findElement(By.xpath("//input[@name='name_on_card']")).sendKeys("serkans");
